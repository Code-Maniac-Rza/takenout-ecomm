...
class Order(models.Model):
    ...
    def get_item_names(self):
        # Retrieve all item names in the order
        item_names = [order_item.product.name for order_item in self.items.all()]
        return item_names
    def get_item_prices(self):
        # Retrieve all item names in the order
        item_prices = [order_item.product.price for order_item in self.items.all()]
        return item_prices
